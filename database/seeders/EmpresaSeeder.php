...
class EmpresaSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('empresa')->updateOrInsert(
            ['NIT' => 900123456],
            [
                'nombre_empresa' => 'TRANSPORTE IBAGUE SAS',
                'doc_representante' => 1000000001,
                'primer_nombre_repre' => 'Carlos',
                'segundo_nombre_repre' => 'Andres',
                'primer_apellido_repre' => 'Ramirez',
                ...
                'correo_corporativo' => 'contacto@transporteibague.com',
                'id_tipo_empresa' => 1,
                'id_ciudad' => '730001',
                'id_estado' => 1,
                'fecha_creacion' => now(),
