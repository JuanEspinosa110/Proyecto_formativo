...
Route::prefix('empresa')->name('empresa.')->group(function () {
    ...
    // 🟢 Grupo GENERAL (Administrador [1] y Auxiliar [5, 8])
    Route::middleware(['auth:web', 'role:1,5,8'])->group(function () {
...
// 🔵 Grupo Exclusivo AUXILIAR (Roles 5 y 8)
Route::prefix('auxiliar')->name('auxiliar.')
    ->middleware(['auth:web', 'role:5,8'])
    ->group(function () {
