            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        ...
                        <a href="{{ route('superadmin.configuracion.estados.export', ['buscar' => request('buscar')]) }}"
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        <form method="GET" action="{{ route('superadmin.configuracion.estados.index') }}" class="row g-3">
                            <div class="col-md-6 col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="buscar" value="{{ request('buscar') }}"
                                        class="form-control border-start-0" placeholder="Buscar por nombre...">
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            @if(request('buscar'))
                                <div class="col-md-2">
                                    <a href="{{ route('superadmin.configuracion.estados.index') }}"
            ...
            <div class="modal-content border-0 shadow">
                ...
                <form action="{{ route('superadmin.configuracion.estados.store') }}" method="POST">
                    ...
                    <div class="modal-body py-4">
                        <div class="mb-0">
                            <label class="form-label fw-semibold">Nombre del Estado <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="nombre_estado" id="nombre_estado"
                                class="form-control @error('nombre_estado') is-invalid @enderror" placeholder="Ej: Activo"
                                required value="{{ old('nombre_estado') }}">
                            @error('nombre_estado')
                    ...
                    <div class="modal-footer border-0 p-3 bg-light">
                        <button type="button" class="btn btn-sm btn-light px-3 fw-bold"
                            data-bs-dismiss="modal">CANCELAR</button>
                        <button type="submit" class="btn btn-sm btn-primary px-4 fw-bold shadow-sm">GUARDAR
                            REGISTRO</button>
                    </div>
                </form>
            </div>
                ...
                <form id="formEditar" method="POST">
                    ...
                    <div class="modal-body py-4">
                        <div class="mb-0">
                            <label class="form-label fw-semibold">Nombre del Estado <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="nombre_estado" id="editNombre"
                                class="form-control @error('nombre_estado') is-invalid @enderror" required
