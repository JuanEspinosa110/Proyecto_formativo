...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm mb-4 rounded-3 pt-1">
        <div class="card-body p-3">
            <form method="GET" action="{{ route('superadmin.tipo_documento.index') }}" class="row g-2 align-items-center">
                <div class="col-md-5">
                ...
                @if(request('buscar'))
                <div class="col-md-1">
                    <a href="{{ route('superadmin.tipo_documento.index') }}" class="btn btn-light w-100 text-muted" title="Limpiar filtro">
