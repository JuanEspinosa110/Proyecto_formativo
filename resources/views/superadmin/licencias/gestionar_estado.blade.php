...
<div class="container sa-licencia-container py-4">
    ...
    <div class="mb-4">
        <h2 class="fw-bold h3">Gestionar Estado: {{ $licencia->empresa->nombre_empresa }}</h2>
        <p class="text-muted">
            ...
            <div class="card sa-status-summary-card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mt-1">
                        ...
                        <span class="fw-bold">{{ $licencia->estado->nombre_estado }}</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card sa-status-summary-card">
                <div class="card-body">
                    ...
                    <div class="fw-bold mt-1 text-truncate">{{ $licencia->plan->nombre_plan }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <form action="#" method="POST">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                <label class="sa-status-option-label w-100">
                    <input type="radio" name="id_estado" value="1" class="d-none" @if($licencia->id_estado == 1) checked @endif>
            ...
            <div class="col-md-3">
                <label class="sa-status-option-label w-100">
                    <input type="radio" name="id_estado" value="3" class="d-none" @if($licencia->id_estado == 3) checked @endif>
            ...
            <div class="col-md-3">
                <label class="sa-status-option-label w-100">
                    <input type="radio" name="id_estado" value="21" class="d-none" @if($licencia->id_estado == 21) checked @endif>
                    <div class="card sa-status-option-card h-100 border-info">
                        <div class="card-body text-center">
                            <i class="fas fa-hourglass-half text-info fs-3 mb-2"></i>
                            <h6 class="fw-bold">En Gracia</h6>
            ...
            <div class="col-md-3">
                <label class="sa-status-option-label w-100">
                    <input type="radio" name="id_estado" value="14" class="d-none" @if($licencia->id_estado == 14) checked @endif>
        ...
        <div class="card sa-licencia-card mb-4 border-0 shadow-sm">
            <div class="card-body">
                ...
                <textarea name="motivo" class="form-control" rows="4" placeholder="Proporcione una explicación detallada de por qué se está realizando este cambio de estado (mín. 20 caracteres)..."></textarea>
                <div class="text-end small text-muted mt-1">0 / 500 caracteres</div>
            </div>
        </div>
        ...
        <div class="alert alert-warning border-warning d-flex align-items-center mb-4 p-3 rounded-3">
            ...
            <div>
                ...
                <p class="small mb-0 text-muted">Está a punto de modificar el acceso de {{ $licencia->empresa->nombre_empresa }}. Esta acción enviará una notificación automática al contacto administrativo del cliente.</p>
            </div>
        </div>

        <div class="d-flex justify-content-end gap-3">
            <a href="#" class="btn btn-light px-4">Cancelar y Volver</a>
