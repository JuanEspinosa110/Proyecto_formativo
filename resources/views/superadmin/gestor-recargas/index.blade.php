...
@section('content')
    <div class="container-fluid py-4 px-4">
        ...
        <div class="gs-header">
            ...
            <a href="{{ route('superadmin.gestores-recargas.create') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <div class="fw-semibold">{{ $gestor->primer_nombre }} {{ $gestor->primer_apellido }}
                                            </div>
                                ...
                                <td>
                                    <div class="gs-actions">
                                        ...
                                        <form method="POST"
                                            ...
                                            @csrf @method('PATCH')
                                            <button type="submit"
                                                class="gs-btn-icon {{ $gestor->id_estado == 1 ? 'danger' : '' }}"
