    ...
    <header class="sigu-navbar" id="sigu-navbar">
        <div class="sigu-navbar-inner">
            ...
            <nav class="sigu-nav" aria-label="Principal">
                ...
                <a href="{{ route('superadmin.configuracion.ciudades.index') }}"
                    class="sigu-nl {{ request()->routeIs('superadmin.configuracion.ciudades.*') ? 'active' : '' }}">
                    <span class="material-symbols-rounded">map</span>
                    <span>Ciudades</span>
                </a>
                <a href="{{ route('superadmin.configuracion.tipo_empresa.index') }}"
