...
<div class="sa-roles-container">
    ...
    <div class="sa-roles-header">
        <div>
            <h1 class="sa-roles-title">Editar: {{ $tipoUsuario->nombre_tipo }}</h1>
            <p class="sa-roles-subtitle">Modifica la información del tipo de usuario</p>
        </div>
    ...
    <!-- Formulario -->
    <form action="{{ route('superadmin.roles.update', $tipoUsuario->id_tipo_usuario) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="sa-roles-card">
            ...
            <div class="sa-roles-card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="sa-roles-form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('nombre_tipo', $tipoUsuario->nombre_tipo) }}"
                    ...
                    <div class="col-md-6">
                        <div class="sa-roles-form-group">
                            <label class="sa-roles-form-label">ID del Tipo</label>
                            <input type="text" 
                                   class="sa-roles-form-control" 
                                   value="{{ $tipoUsuario->id_tipo_usuario }}"
                                   readonly
                                   style="background-color: #e9ecef;">
                            <small class="sa-roles-form-text">Identificador único en el sistema</small>
                        </div>
                    </div>
        ...
        <div class="sa-roles-card">
            <div class="sa-roles-card-header">
                <h2 class="sa-roles-card-title">Permisos Asignados (Vista Demo)</h2>
            </div>
            <div class="sa-roles-card-body">
