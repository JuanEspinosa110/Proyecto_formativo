...
<nav class="navbar navbar-expand-lg fixed-top bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">ViajaFácil</a>
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="#tarjetas">Tarjeta</a></li>
...
<section class="hero-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <span class="badge bg-primary mb-3">Nuevo sistema digital</span>
                <h1 class="hero-title">
...
<footer class="footer">
    <div class="container text-center">
        <p class="mb-0">© 2026 ViajaFácil - Sistema de Transporte Digital</p>
    </div>
</footer>
