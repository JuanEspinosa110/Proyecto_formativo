        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light">
                    <tr>
                        <th class="ps-4 py-3 text-uppercase small fw-bold text-muted border-0">Vehículo</th>
                        <th class="py-3 text-uppercase small fw-bold text-muted border-0">Referencia/Modelo</th>
                        ...
                        <tr class="border-top">
                            <td class="ps-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted fs-xs">{{ optional($bus->empresa)->nombre_empresa ?? '—' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td>{{ $bus->modelo ?? 'N/D' }}</td>
                            <td>
                                <span class="badge bg-light text-dark border px-2 fw-medium">{{ $bus->capacidad_pasajeros }} pasj.</span>
                            </td>
                            <td class="text-muted small">
                                <span class="material-symbols-rounded fs-6 align-middle opacity-50">speed</span> 
                                {{ number_format($bus->kilometraje) }} km
                            </td>
                            <td>
                                @php
                                    $c = match($bus->id_estado) {
                                        1 => 'success',
                                        2 => 'danger',
                                        7 => 'info',
                                        default => 'warning'
                            ...
                            <td class="text-end pe-4">
                                <button class="btn btn-outline-primary btn-sm rounded-3 edit-bus" 
                                        data-bs-toggle="modal" data-bs-target="#modalEditBus"
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="placa" class="form-control bg-light border-0 py-2" placeholder="Ej: ABC-123" required style="text-transform:uppercase">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="modelo" class="form-control bg-light border-0 py-2" placeholder="Ej: Toyota 2024" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="capacidad_pasajeros" class="form-control bg-light border-0 py-2" required min="10" placeholder="Ej: 40">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="kilometraje" class="form-control bg-light border-0 py-2" required min="0" placeholder="0">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <form id="formEditBus" method="POST">
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-0"><span class="material-symbols-rounded fs-5">tag</span></span>
                                <input type="text" id="edit_placa_display" class="form-control bg-light border-0 fw-bold text-primary" disabled>
                            </div>
                            <small class="text-muted" style="font-size: 0.7rem">Este identificador no puede ser modificado.</small>
                        </div>

                        <!-- Modelo -->
                        <div class="col-md-12">
                            <label class="form-label small fw-bold text-muted text-uppercase">Modelo / Referencia <span class="text-danger">*</span></label>
                            <input type="text" name="modelo" id="edit_modelo" class="form-control bg-light border-0 py-2" placeholder="Ej: Toyota 2024" required>
                            <div class="invalid-feedback feedback-modelo"></div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="capacidad_pasajeros" id="edit_capacidad" class="form-control bg-light border-0 py-2" required min="10" placeholder="Ej: 40">
                            <div class="invalid-feedback feedback-capacidad_pasajeros"></div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-muted text-uppercase">Kilometraje <span class="text-danger">*</span></label>
                            <input type="number" name="kilometraje" id="edit_kilometraje" class="form-control bg-light border-0 py-2" required min="0">
                            <div class="invalid-feedback feedback-kilometraje"></div>
                        </div>
                ...
                <div class="modal-footer border-top-0 px-4 pb-4 px-4 bg-white d-flex gap-2">
                    <button type="button" class="btn btn-light px-4 fw-semibold border" data-bs-dismiss="modal">Cancelar</button>
...
<style>
    ...
    .table-hover tbody tr:hover { background-color: rgba(94, 84, 142, 0.03) !important; }
</style>
@endpush
@endsection
