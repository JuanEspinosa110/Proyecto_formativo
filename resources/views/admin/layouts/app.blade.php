    ...
    <aside class="sigu-sidebar" id="sigu-sidebar">
        <div class="sigu-sidebar-inner">
            <a href="{{ route('admin.dashboard') }}" class="sigu-brand">
                <div class="sigu-brand-mark" aria-hidden="true"><span class="material-symbols-rounded">route</span>
                </div>
                <div class="sigu-brand-text">
                    <span class="sigu-brand-name">SIGU</span>
                    <span
                        class="sigu-brand-sub">{{ Auth::user()->id_tipo_usuario == 1 ? 'Administración' : 'Auxiliar' }}</span>
                </div>
            </a>
            ...
            <nav class="sigu-sidebar-nav" aria-label="Administrador">
                <a href="{{ route($routePrefix . '.dashboard') }}"
                    class="sigu-sb-link {{ request()->routeIs($routePrefix . '.dashboard') ? 'active' : '' }}">
                    <span class="sb-ico"><span class="material-symbols-rounded">dashboard</span></span>
                    <span>Dashboard</span>
                </a>

                <a href="{{ route($routePrefix . '.usuarios.index') }}"
                    class="sigu-sb-link {{ request()->routeIs($routePrefix . '.usuarios.*') ? 'active' : '' }}">
                    <span class="sb-ico"><span class="material-symbols-rounded">people</span></span>
                    <span>Usuarios</span>
                </a>

                <a href="{{ route($routePrefix . '.documentos.index') }}"
                    class="sigu-sb-link {{ request()->routeIs($routePrefix . '.documentos.*') ? 'active' : '' }}">
                    <span class="sb-ico"><span class="material-symbols-rounded">description</span></span>
                    <span>Docs. Vehículos</span>
                </a>

                <a href="{{ route($routePrefix . '.buses.index') }}"
                    class="sigu-sb-link {{ request()->routeIs($routePrefix . '.buses.*') ? 'active' : '' }}">
                ...
                <a href="{{ route($routePrefix . '.asignaciones.index') }}"
                    class="sigu-sb-link {{ request()->routeIs($routePrefix . '.asignaciones.*') ? 'active' : '' }}">
                    <span class="sb-ico"><span class="material-symbols-rounded">assignment</span></span>
                    <span>Asignaciones</span>
                </a>

                <a href="{{ route('empresa.reportes.index') }}"
                    class="sigu-sb-link {{ request()->routeIs('empresa.reportes.*') ? 'active' : '' }}">
                ...
                @if(Auth::user()->id_tipo_usuario == 1)
                    <a href="{{ route('admin.rutas.index') }}"
                        class="sigu-sb-link {{ request()->routeIs('admin.rutas.*') ? 'active' : '' }}">
                    ...
                    <p class="small text-uppercase px-4 mb-2" style="font-size:10px; opacity:0.6; letter-spacing:1px;">
                        Mantenimiento</p>

                    <a href="{{ route('admin.mantenimiento.reportes') }}"
                        class="sigu-sb-link {{ request()->routeIs('admin.mantenimiento.reportes') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.mantenimiento.index') }}"
                        class="sigu-sb-link {{ request()->routeIs('admin.mantenimiento.*') && !request()->routeIs('admin.mantenimiento.reportes') ? 'active' : '' }}">
