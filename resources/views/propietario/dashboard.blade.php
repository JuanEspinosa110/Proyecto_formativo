...
<div class="container-fluid pb-5">
    ...
    <div id="section-dashboard">
        <div class="row mb-5">
            <div class="col-12">
                <span class="text-primary fw-bold text-uppercase small letter-spacing-1 mb-2 d-block">Panel del Propietario</span>
        ...
        <div class="alert alert-warning border-0 shadow-sm rounded-4 p-4 mb-5 d-flex align-items-center gap-4">
            ...
            <div>
                ...
                <p class="mb-0 text-dark opacity-75">No tienes vehículos asociados a tu documento en este momento. Por favor, contacta al administrador para vincular tus buses y poder visualizar tu operación.</p>
            </div>
        </div>
        @endif
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small fw-bold text-uppercase mb-0">Ingresos Totales ({{ $conteoPasajeros }} Pax)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    ...
                    <div class="bg-light p-4 rounded-4 border-start border-4 border-primary">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <span class="text-muted small text-uppercase fw-bold d-block mb-1">Ruta Actual/Última</span>
                                <h4 class="fw-bold text-dark mb-0">{{ $ultimaAsignacion->ruta->nombre_ruta ?? 'Ruta Express' }}</h4>
                                <div class="d-flex gap-2 align-items-center mt-1">
                                    <span class="badge bg-primary px-2 rounded-1">{{ $ultimaAsignacion->placa }}</span>
                                    <span class="text-muted small">{{ $ultimaAsignacion->ruta->codigo_ruta ?? 'REG-001' }}</span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <span class="text-muted small text-uppercase fw-bold d-block mb-1">Conductor</span>
                                <span class="text-dark fw-medium small">{{ $ultimaAsignacion->conductor->primer_nombre }} {{ $ultimaAsignacion->conductor->primer_apellido }}</span>
                            </div>
                            <div class="col-md-4 text-md-end">
                                <span class="badge bg-primary px-3 rounded-pill">{{ optional($ultimaAsignacion->estado)->nombre_estado }}</span>
                            </div>
                        </div>
                    </div>
                    @else
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-lg rounded-4 p-4 h-100 text-white" style="background: linear-gradient(135deg, #110726 0%, #2c1654 100%) !important;">
                    ...
                    <div class="d-flex flex-column gap-3 overflow-auto" style="max-height: 200px;">
                        @forelse($buses as $b)
                        <div class="d-flex justify-content-between align-items-center text-white-50 small border-bottom border-secondary border-opacity-10 pb-2">
                            <div>
                    ...
                    <div class="text-center mt-auto pt-3">
                         <a href="{{ route('propietario.dashboard', ['section' => 'vehiculo']) }}" class="btn btn-outline-light btn-sm w-100 rounded-pill">Gestionar Flota</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-3 bg-light d-flex align-items-center justify-content-center p-4 border-end">
                            <div class="text-center">
                                <div class="bg-white shadow-sm rounded-circle p-4 mb-3 d-inline-flex align-items-center justify-content-center" style="width: 120px; height: 120px;">
                                    <span class="material-symbols-rounded text-primary" style="font-size: 3.5rem !important;">directions_bus</span>
                                </div>
                                <h2 class="fw-black text-dark mb-0 d-flex align-items-center justify-content-center gap-2">
                                    ...
                                    @endphp
                                    <span class="material-symbols-rounded text-{{ $peorStatusColor }} fs-4" title="Estado Documental">event_available</span>
                                </h2>
                                <span class="badge bg-primary-subtle text-primary px-3 rounded-pill mt-2">{{ $b->modelo }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9 p-4">
                            <div class="row g-3">
                                <div class="col-sm-6 col-md-3">
                                    <label class="text-muted small fw-bold text-uppercase d-block mb-1">Capacidad</label>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <label class="text-muted small fw-bold text-uppercase d-block mb-1">Kilometraje</label>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="material-symbols-rounded text-muted fs-5">speed</span>
                                        <span class="text-dark fw-bold">{{ number_format($b->kilometraje ?? 0) }} KM</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="text-dark family-monospace small">{{ $b->numero_chasis ?? '---' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <label class="text-muted small fw-bold text-uppercase d-block mb-1">Motor</label>
                                    <span class="text-dark family-monospace small">{{ $b->numero_motor ?? '---' }}</span>
                                </div>
                                <div class="col-12 mt-3 pt-3 border-top d-flex flex-wrap gap-2">
                                    <button class="btn btn-primary d-flex align-items-center gap-2 px-4 rounded-pill fw-bold btn-ver-vehiculo" data-placa="{{ $b->placa }}">
                                        <span class="material-symbols-rounded fs-5">visibility</span>
                                        Ver Ficha Completa
                                    </button>
                                    <button class="btn btn-outline-dark d-flex align-items-center gap-2 px-4 rounded-pill fw-bold btn-historial-docs" data-placa="{{ $b->placa }}">
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="badge bg-primary bg-opacity-10 text-primary x-small rounded-pill px-2 border border-primary border-opacity-10">{{ $doc->placa }}</span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="text-muted small text-truncate" style="max-width: 150px;" title="{{ $doc->nombre }}">
                                    {{ $doc->nombre }}
                                </div>
                            </td>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    @endif
                                    <button class="btn btn-sm btn-light border p-2 rounded-circle text-{{ $doc->status_color }}" 
                                    ...
                                    <button class="btn btn-sm btn-light border p-2 rounded-circle text-dark btn-historial-docs" 
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
            <form action="{{ route('propietario.dashboard') }}" method="GET" class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="conductor" class="form-control rounded-3" placeholder="Nombre..." value="{{ request('conductor') }}">
                </div>
                <div class="col-md-2">
                    <label class="form-label small fw-bold text-muted text-uppercase">Ruta</label>
                    <input type="text" name="ruta" class="form-control rounded-3" placeholder="Nombre ruta..." value="{{ request('ruta') }}">
                </div>
                <div class="col-md-2">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-primary bg-opacity-10 text-primary border-primary border px-2">{{ $asig->placa }}</span></td>
                            <td>
                                <div class="fw-bold text-dark">{{ $asig->ruta->nombre_ruta ?? 'N/A' }}</div>
                                <small class="text-muted d-block">{{ $asig->conductor->primer_nombre }} {{ $asig->conductor->primer_apellido }}</small>
                            </td>
                            <td>
                                <div class="d-flex flex-column small">
                                    <span class="text-dark fw-bold">{{ \Carbon\Carbon::parse($asig->fecha)->format('H:i') }} - {{ \Carbon\Carbon::parse($asig->fecha)->addHours(8)->format('H:i') }}</span>
                            ...
                            <td class="text-center">
                                <span class="badge bg-light text-dark border rounded-pill px-3">{{ $asig->ventas->count() }}</span>
                            </td>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary bg-opacity-10 text-secondary border px-2">{{ $h->placa }}</span></td>
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <span class="material-symbols-rounded fs-1 opacity-25">manage_search</span>
                                <p class="text-muted mt-2 mb-0">Aún no se registran cambios históricos para este vehículo.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form action="{{ route('propietario.subirDocumento') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label small fw-bold text-muted text-uppercase">Vehículo <span class="text-danger">*</span></label>
                            <select name="placa" id="subir_placa" class="form-select rounded-3 shadow-sm border-light" required>
                                <option value="" disabled selected>Seleccionar placa...</option>
                                @foreach($buses as $b)
                                <option value="{{ $b->placa }}" data-modelo="{{ preg_replace('/[^0-9]/', '', $b->modelo) }}">{{ $b->placa }} - {{ $b->modelo }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-bold text-muted text-uppercase">Tipo de Documento <span class="text-danger">*</span></label>
                            <select name="id_tipo_documento" id="subir_id_tipo_documento" class="form-select rounded-3 shadow-sm border-light" required>
                        ...
                        <div class="col-12 d-none" id="col_fecha_nacimiento">
                            <label class="form-label small fw-bold text-muted text-uppercase">Fecha de Nacimiento (Conductor) <span class="text-danger">*</span></label>
                            <input type="date" name="fecha_nacimiento" id="subir_fecha_nacimiento" class="form-control rounded-3" placeholder="Para calcular vigencia">
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <label class="form-label small fw-bold text-muted text-uppercase">Archivo digital (PDF/JPG)</label>
                            <input type="file" name="archivo" class="form-control rounded-3" accept=".pdf,.jpg,.jpeg,.png" required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-4 pt-0">
                    <button type="button" class="btn btn-light fw-bold px-4 rounded-pill" data-bs-dismiss="modal">Cerrar</button>
                    <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm rounded-pill">Subir archivo</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" id="edit_nombre_display" class="form-control bg-light rounded-3" readonly disabled>
                        </div>
                        <div class="col-6">
                            <label class="form-label small fw-bold text-muted text-uppercase">Expedición</label>
                            <input type="date" name="fecha_expedicion" id="edit_expedicion" class="form-control rounded-3" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label small fw-bold text-muted text-uppercase">Vencimiento</label>
                        ...
                        <div class="col-12">
                            <label class="form-label small fw-bold text-muted text-uppercase">Nuevo Archivo (Opcional)</label>
                            <input type="file" name="archivo" class="form-control rounded-3" accept=".pdf,.jpg,.jpeg,.png">
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-4 pt-0">
                    <button type="button" class="btn btn-light fw-bold px-4 rounded-pill" data-bs-dismiss="modal">Descartar</button>
                    <button type="submit" class="btn btn-warning fw-bold px-4 shadow-sm rounded-pill text-dark">Aplicar cambios</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3 col-6">
                                        <div class="p-3 rounded-4 bg-light border border-white h-100">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Capacidad</label>
                                            <span id="ver_capacidad" class="text-dark fw-bold">---</span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="p-3 rounded-4 bg-light border border-white h-100">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Kilometraje</label>
                                            <span id="ver_kilometraje" class="text-dark fw-bold">---</span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="p-3 rounded-4 bg-light border border-white h-100">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Licencia</label>
                                            <span id="ver_licencia" class="text-dark fw-bold">---</span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-6">
                                        <div class="p-3 rounded-4 bg-light border border-white h-100">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Estado</label>
                                            <span id="ver_estado" class="badge rounded-pill px-3 py-2">---</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="p-3 rounded-4 bg-light border border-white">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Número de Chasis</label>
                                            <span id="ver_chasis" class="text-dark family-monospace small fw-bold">---</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="p-3 rounded-4 bg-light border border-white">
                                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Número de Motor</label>
                                            <span id="ver_motor" class="text-dark family-monospace small fw-bold">---</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body p-4">
                                ...
                                <div id="ver_conductor_box" class="h-100">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="badge bg-primary-subtle text-primary x-small" id="cond_ruta">---</span>
                                        </div>
                                    </div>
                                ...
                                <div id="no_conductor_box" class="d-none alert alert-light text-center rounded-4 p-4 mb-0">
            ...
            <div class="modal-footer border-0 p-4 bg-light">
                <button type="button" class="btn btn-dark fw-bold px-5 rounded-pill" data-bs-dismiss="modal">Cerrar Expediente</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4 bg-light">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="card border-0 shadow-sm rounded-4 p-3 h-100">
                            <label class="text-muted x-small fw-bold text-uppercase d-block mb-1">Horario Turno (8h)</label>
            ...
            <div class="modal-footer border-0 p-4 bg-light">
                <button type="button" class="btn btn-dark fw-bold px-5 rounded-pill" data-bs-dismiss="modal">Cerrar Detalle</button>
            </div>
        </div>
    </div>
</div>
