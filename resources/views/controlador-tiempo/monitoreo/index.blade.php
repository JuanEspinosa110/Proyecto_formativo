        ...
        <div class="col-6 col-md-3">
            <div class="bg-white rounded-3 shadow-sm p-3 ct-kpi d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">Flota total</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="bg-white rounded-3 shadow-sm p-4 h-100" style="border-top: 3px solid var(--ct-accent);">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <span class="badge {{ $badgeClass }} border rounded-pill px-3" style="font-size:0.75rem; font-weight:600;">
                            {{ $estadoBus }}
                        </span>
                    </div>
        ...
        @empty
            <div class="col-12">
                <div class="bg-white rounded-3 shadow-sm p-5 text-center">
                    <span class="material-symbols-rounded d-block mb-2" style="font-size:3rem; color:var(--ct-accent);">directions_bus</span>
                    <p class="text-muted mb-0">No hay buses registrados para esta empresa.</p>
                </div>
            </div>
        @endforelse
    </div>
