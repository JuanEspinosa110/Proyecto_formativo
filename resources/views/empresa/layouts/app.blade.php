...
<body class="sigu-body sigu-admin-layout">
    ...
    <aside class="sigu-sidebar" id="sigu-sidebar">
        <div class="sigu-sidebar-inner">
            <a href="{{ route('empresa.dashboard') }}" class="sigu-brand">
            ...
            <nav class="sigu-sidebar-nav" aria-label="Empresa">
                <a href="{{ route('empresa.dashboard') }}" class="sigu-sb-link {{ request()->routeIs('empresa.dashboard') ? 'active' : '' }}">
